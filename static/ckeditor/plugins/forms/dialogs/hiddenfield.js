    ...
    return {
        title: d.lang.forms.hidden.title, hiddenField: null, minWidth: 350, minHeight: 110, onShow: function () {
            ...
            var a = this.getValueOf("info", "_cke_saved_name"),
                b = this.getParentEditor(), a = 8 > CKEDITOR.document.$.documentMode ? '<input name="' + CKEDITOR.tools.htmlEncode(a) + '">' : "input", a = CKEDITOR.env.ie && b.document.createElement(a);
            ...
            id: "info", label: d.lang.forms.hidden.title, title: d.lang.forms.hidden.title, elements: [{
                id: "_cke_saved_name", type: "text",
                label: d.lang.forms.hidden.name, "default": "", accessKey: "N", setup: function (a) {
